...
class db
{
	...
	public function __construct()
	{
		...
		$this->where="";
		try {
   	 		$this->dbh = new PDO("mysql:host=".AWConfig::db_host.";dbname=".AWConfig::db_name, AWConfig::db_user, AWConfig::db_password,array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
